 ...
 *
 ***************************************************************/
void Meta::addClass( const std::type_info& ti, const Meta* c) {
 ...
 *
 ***************************************************************/
const Meta* Meta::find( const std::type_info& theClass  ) {
 ...
 *
 ***************************************************************/
Meta::Meta( const std::type_info& theClass )
  : myTypeInfo( theClass ) {
 ...
 *
 ***************************************************************/
bool Meta::is( const std::type_info& ti ) {
  if ( ti == myTypeInfo ) {
    return true;
  }
  else {
