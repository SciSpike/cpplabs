 ...
 *
 ***************************************************************/
CounterView::CounterView ( Counter* c, ObservableButton *inc, ObservableButton *dec ) {
  incButton = inc;
  decButton = dec;
  myCounter = c;
  incButton->attach( this );
  decButton->attach( this );
}
 ...
 *
 ***************************************************************/
void CounterView::update (Subject* s ) {
  if( s == incButton ) {
    increment();
  }
  else {
